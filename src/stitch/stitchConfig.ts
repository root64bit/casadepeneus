 ...
 * Project Name: Modern Gestão Pneus Lda. (Casa de Pneus, Lda.)
 */

export const STITCH_CONFIG = {
  projectId: "786368460448211335",
  title: "Modern Gestão Pneus Lda.",
  visibility: "PUBLIC",
  deviceType: "DESKTOP",
  ...
  screens: [
    {
      ...
      title: "Início - Casa de Pneus",
      route: "dashboard"
    },
    {
      id: "5e21e469189844468a8eddae836ea87d",
      title: "Artigos e Stock - Casa de Pneus",
      route: "inventory"
    },
    {
      id: "0587efb8ca494de9983bb568e3b16225",
      title: "Nova Venda - Casa de Pneus",
      route: "sales"
    }
  ]
};
